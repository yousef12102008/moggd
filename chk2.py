def chk(card):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..lqv_9x6z8XVjsIIfJi4xNI3ElZuK9U9OjjeDeuuVzO1MIvt-jYw2Fzp0vNYsnrVdjD8jn-vB4yzd1aHioRwYdw',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'dropin2',
        'sessionId': 'c582d997-fda5-49a4-a7f7-058ba3de60f2',
    },
...
#data = '{"clientSdkMetadata":{"source":"client","integration":"dropin2","sessionId":"c582d997-fda5-49a4-a7f7-058ba3de60f2"},"query":"mutation TokenizeCreditCard($input: TokenizeCreditCardInput!) {   tokenizeCreditCard(input: $input) {     token     creditCard {       bin       brandCode       last4       cardholderName       expirationMonth      expirationYear      binData {         prepaid         healthcare         debit         durbinRegulated         commercial         payroll         issuingBank         countryOfIssuance         productId       }     }   } }","variables":{"input":{"creditCard":{"number":"5332480249303415","expirationMonth":"09","expirationYear":"2028","cvv":"381","billingAddress":{"postalCode":"10080"}},"options":{"validate":false}}},"operationName":"TokenizeCreditCard"}'
...
#2
    ...
    'sbjs_current_add': 'fd%3D2024-09-07%2022%3A06%3A37%7C%7C%7Cep%3Dhttps%3A%2F%2Fcaliforniabalsamic.com%2Fmy-account%2Fadd-payment-method%2F%7C%7C%7Crf%3D%28none%29',
    'sbjs_first_add': 'fd%3D2024-09-07%2022%3A06%3A37%7C%7C%7Cep%3Dhttps%3A%2F%2Fcaliforniabalsamic.com%2Fmy-account%2Fadd-payment-method%2F%7C%7C%7Crf%3D%28none%29',
    ...
    '_ga_VCS9LN7CYC': 'GS1.1.1725746797.8.0.1725746797.0.0.0',
}
    ...
    'braintree_cc_device_data': '{"device_session_id":"f3e798a0f38e8d38a97c71d4d1af3d28","fraud_merchant_id":null,"correlation_id":"590af043-f960-4ee3-8ef5-9ab20c5f"}',
    ...
    'woocommerce-add-payment-method-nonce': '5dbf5969fd',
