def chk(card):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..sJXPc1GZ95PhXRROdEJhzLAfFSqgkMReaSgoDkRk33d922fgXa0HphiS58zQp3PIIEIqoP_PjqiKi9T0ZM1blQ',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'custom',
        'sessionId': '89e4628f-5be7-48d4-913c-eaba00bc8611',
    },
...
#data = '{"clientSdkMetadata":{"source":"client","integration":"custom","sessionId":"89e4628f-5be7-48d4-913c-eaba00bc8611"},"query":"mutation TokenizeCreditCard($input: TokenizeCreditCardInput!) {   tokenizeCreditCard(input: $input) {     token     creditCard {       bin       brandCode       last4       cardholderName       expirationMonth      expirationYear      binData {         prepaid         healthcare         debit         durbinRegulated         commercial         payroll         issuingBank         countryOfIssuance         productId       }     }   } }","variables":{"input":{"creditCard":{"number":"4403934237294603","expirationMonth":"12","expirationYear":"2027","cvv":"743"},"options":{"validate":false}}},"operationName":"TokenizeCreditCard"}'
#response = requests.post('https://payments.braintree-api.com/graphql', headers=headers, data=data)
    ...
    '_ga_JVCGZDD7ML': 'GS1.1.1719715681.2.1.1719715712.29.0.176066979',
    ...
    'woocommerce-add-payment-method-nonce': '2855e2c89e',
